<x-pulse::card class="col-span-{{ $cols }}">
    <x-slot:title>
        <x-pulse::card-title class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2 stroke-gray-500 dark:stroke-gray-600">
        ...
        <div class="flex items-center gap-2">
            <div class="text-sm text-gray-700 dark:text-gray-300">Sort by</div>
            <select
                wire:model="orderBy"
                            ...
                            <tbody>
                                @foreach ($exceptions as $exception)
                                    <tr wire:key="{{ $exception->class.$exception->location }}">
                                        ...
                                        <x-pulse::td class="text-center text-gray-700 dark:text-gray-300 text-sm font-bold whitespace-nowrap tabular-nums">
