...
it('renders top 10 users making requests', function () {
    ...
    Pulse::ignore(fn () => DB::table('pulse_requests')->insert([
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[0]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => false],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[0]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => false],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[0]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => false],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[1]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => false],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[1]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => false],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[2]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => false],
    ]));
...
it('renders top 10 users experiencing slow endpoints', function () {
    ...
    Pulse::resolveUsersUsing(fn () => $users);
    Pulse::ignore(fn () => DB::table('pulse_requests')->insert([
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[0]->id, 'route' => 'GET /', 'duration' => 1234, 'reached_threshold' => true],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[0]->id, 'route' => 'GET /', 'duration' => 1234, 'reached_threshold' => true],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[1]->id, 'route' => 'GET /', 'duration' => 1234, 'reached_threshold' => true],
        ['date' => '2000-01-02 03:04:05', 'user_id' => $users[1]->id, 'route' => 'GET /', 'duration' => 123, 'reached_threshold' => true],
    ]));
